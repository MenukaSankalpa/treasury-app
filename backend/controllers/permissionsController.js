...
// Handles NULL, empty string, already-parsed objects (mysql2 sometimes
// auto-parses JSON columns), and malformed JSON — never throws.
...
export async function getPermissions(req, res) {
  try {
    ...
    const actionAccess = {};
    actions.forEach(a => actionAccess[a.action_key] = {
