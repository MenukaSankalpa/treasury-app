...
export const fmtM = n => `LKR ${(Number(n)/1e6).toFixed(1)}M`;
export const fmtFull = n => "LKR " + Math.round(Number(n)).toLocaleString();
export const fmtUSD = n => "USD " + Number(n).toLocaleString();
